...
<<<<<<< HEAD <div class="fullwidthbanner-container">
                                ...
                                <div class="col-sm-3">
                                    <div class="single-item">
                                        ...
                                        <div class=" single-item-body">
                                            <p class="single-item-title">{{$new ->unit_price}}đồng
                                            </p>
            ...
            <div class="main-content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="single-item">
                            <div class="single-item-header">
                                <a href="product.html"><img class="images_item"
